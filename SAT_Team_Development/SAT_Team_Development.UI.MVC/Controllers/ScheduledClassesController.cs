...
namespace SAT_Team_Development.UI.MVC.Controllers
{
    ...
    public class ScheduledClassesController : Controller
    {
        ...
        public ScheduledClassesController(SAT_Administration_ToolContext context)
        {
            _context = context;
        }
        ...
        {
            var sAT_Administration_ToolContext = _context.ScheduledClasses.Include(s => s.Course).Include(s => s.Scs);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SAT_Administration_ToolContext.ScheduledClasses'  is null.");
            }
            var scheduledClass = await _context.ScheduledClasses.FindAsync(id);
            if (scheduledClass != null)
            {
